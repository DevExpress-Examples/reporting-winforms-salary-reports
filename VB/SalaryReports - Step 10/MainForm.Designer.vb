...
'			Me.windowsUIView1.QueryControl += New DevExpress.XtraBars.Docking2010.Views.QueryControlEventHandler(Me.windowsUIView1_QueryControl);
			...
			Me.tileManagementReport.Elements.Add(tileItemElement1)
			...
			Me.tileAllEmployeeReport.Elements.Add(tileItemElement2)
			...
			Me.tileEmployeeReport.Elements.Add(tileItemElement3)
			...
			Me.tileSettings.Elements.Add(tileItemElement4)
